...
final Map<String, TextEditingController>
    _UploadVehicleDetailsViewTextEditingControllers = {};

final Map<String, FocusNode> _UploadVehicleDetailsViewFocusNodes = {};

final Map<String, String? Function(String?)?>
    _UploadVehicleDetailsViewTextValidations = {
...
mixin $UploadVehicleDetailsView {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_UploadVehicleDetailsViewTextEditingControllers.containsKey(key)) {
      return _UploadVehicleDetailsViewTextEditingControllers[key]!;
    }

    _UploadVehicleDetailsViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _UploadVehicleDetailsViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_UploadVehicleDetailsViewFocusNodes.containsKey(key)) {
      return _UploadVehicleDetailsViewFocusNodes[key]!;
    }
    _UploadVehicleDetailsViewFocusNodes[key] = FocusNode();
    return _UploadVehicleDetailsViewFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller
        in _UploadVehicleDetailsViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _UploadVehicleDetailsViewFocusNodes.values) {
      focusNode.dispose();
    }

    _UploadVehicleDetailsViewTextEditingControllers.clear();
    _UploadVehicleDetailsViewFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set makeValue(String? value) {
    ...
    if (_UploadVehicleDetailsViewTextEditingControllers.containsKey(
        MakeValueKey)) {
      _UploadVehicleDetailsViewTextEditingControllers[MakeValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set modelValue(String? value) {
    ...
    if (_UploadVehicleDetailsViewTextEditingControllers.containsKey(
        ModelValueKey)) {
      _UploadVehicleDetailsViewTextEditingControllers[ModelValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set yearValue(String? value) {
    ...
    if (_UploadVehicleDetailsViewTextEditingControllers.containsKey(
        YearValueKey)) {
      _UploadVehicleDetailsViewTextEditingControllers[YearValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set licensePlateValue(String? value) {
    ...
    if (_UploadVehicleDetailsViewTextEditingControllers.containsKey(
      ...
      _UploadVehicleDetailsViewTextEditingControllers[LicensePlateValueKey]
          ?.text = value ?? '';
    }
  }
  ...
  set vehicleColorValue(String? value) {
    ...
    if (_UploadVehicleDetailsViewTextEditingControllers.containsKey(
      ...
      _UploadVehicleDetailsViewTextEditingControllers[VehicleColorValueKey]
          ?.text = value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _UploadVehicleDetailsViewTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _UploadVehicleDetailsViewTextEditingControllers[key]!.text,
  );
