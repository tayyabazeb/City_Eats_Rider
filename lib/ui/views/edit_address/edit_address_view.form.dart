...
final Map<String, TextEditingController>
    _EditAddressViewTextEditingControllers = {};

final Map<String, FocusNode> _EditAddressViewFocusNodes = {};

final Map<String, String? Function(String?)?> _EditAddressViewTextValidations =
    {
...
mixin $EditAddressView {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_EditAddressViewTextEditingControllers.containsKey(key)) {
      return _EditAddressViewTextEditingControllers[key]!;
    }

    _EditAddressViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _EditAddressViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_EditAddressViewFocusNodes.containsKey(key)) {
      return _EditAddressViewFocusNodes[key]!;
    }
    _EditAddressViewFocusNodes[key] = FocusNode();
    return _EditAddressViewFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller in _EditAddressViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _EditAddressViewFocusNodes.values) {
      focusNode.dispose();
    }

    _EditAddressViewTextEditingControllers.clear();
    _EditAddressViewFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set streetValue(String? value) {
    ...
    if (_EditAddressViewTextEditingControllers.containsKey(StreetValueKey)) {
      _EditAddressViewTextEditingControllers[StreetValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set buildingValue(String? value) {
    ...
    if (_EditAddressViewTextEditingControllers.containsKey(BuildingValueKey)) {
      _EditAddressViewTextEditingControllers[BuildingValueKey]?.text =
          value ?? '';
    }
  }
  ...
  set cityValue(String? value) {
    ...
    if (_EditAddressViewTextEditingControllers.containsKey(CityValueKey)) {
      _EditAddressViewTextEditingControllers[CityValueKey]?.text = value ?? '';
    }
  }
  ...
  set stateValue(String? value) {
    ...
    if (_EditAddressViewTextEditingControllers.containsKey(StateValueKey)) {
      _EditAddressViewTextEditingControllers[StateValueKey]?.text = value ?? '';
    }
  }
  ...
  set zipCodeValue(String? value) {
    ...
    if (_EditAddressViewTextEditingControllers.containsKey(ZipCodeValueKey)) {
      _EditAddressViewTextEditingControllers[ZipCodeValueKey]?.text =
          value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _EditAddressViewTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _EditAddressViewTextEditingControllers[key]!.text,
  );
